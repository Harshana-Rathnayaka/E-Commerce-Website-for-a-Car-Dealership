                        ...
                        <div class="col-sm-11">
                            ...
                            <form action="../api/updateUserDetails.php" class="form-horizontal" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" name="fname" value="<?php echo $result['first_name'] ?>" placeholder="Enter your first name" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" name="lname" value="<?php echo $result['last_name'] ?>" placeholder="Enter your last name" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" name="uname" value="<?php echo $result['username'] ?>" placeholder="Enter your username" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="date" name="birthday" value="<?php echo $result['birthday'] ?>" required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="email" name="email" value="<?php echo $result['email'] ?>" placeholder="Enter your email" class="form-control">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="i-checks">
                                            ...
                                            if ($result['gender'] == 'male') {
                                                ...
                                                <input type="radio" checked value="male" name="gender" class="radio-template">
                                            ...
                                            <?php
                                                ...
                                                <input type="radio" value="female" checked name="gender" class="radio-template">
                                                <label class="col-sm-3 form-control-label">Female</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="tel" name="contact" value="<?php echo $result['contact'] ?>" placeholder="Enter your phone number" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 ml-auto">
                                        ...
                                        <button type="submit" name="btnUpdate" class="btn btn-outline-success">Save changes</button>
                                    </div>
                                </div>
